...
//  Serial.println("new client");
  ...
  //s += "<h1>کنترل وسایل</h1>";
  //s += "<div class=\"row\">";
  //s += "<div class=\"col-md-2\"><input class=\"btn btn-block btn-lg btn-success\"style=\"font-size:28px;border-radius:100%;height:100px;width:100px;\"type=\"button\" value=\"روشن\" onclick=\"on()\"></div>";
  //s += "<div class=\"col-md-2\"><input class=\"btn btn-block btn-lg btn-danger\"style=\"font-size:28px;border-radius:100%;height:100px;width:100px;\" type=\"button\" value=\"خاموش\" onclick=\"off()\"></div>";
  //s += "</div></div>";

  //s += "<script>function on() {$.post(\"/on\");}</script>";
  //s += "<script>function off() {$.post(\"/off\");}</script>";
